package vttp.ssf.assessment.eventmanagement.AppConfig;
...
public class AppConfig {
   ...
   @Bean("Event")//This is to give a name to the bean, and beans allow the method to be used in the springboot framework
